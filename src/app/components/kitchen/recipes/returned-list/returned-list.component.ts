...
export class ReturnedListComponent implements OnInit {
  ...
  getInfoUsingName(searchName: string) {
    ...
    this._apiServices
      .get(
        `recipes/complexSearch?query=${searchName}&addRecipeInformation=true&number=12`
      )
      .subscribe(
        (responseId) => {
          this.spinner.hide();
  ...
  getInfoUsingIngredients(searchName: string) {
    ...
    this._apiServices
      .get(`recipes/findByIngredients?ingredients=${searchName}&number=12`)
      .subscribe(
        (responseId) => {
          this.spinner.hide();
  ...
  getInfoUsingTypes(searchName: string) {
    ...
    this._apiServices
      .get(
        `recipes/complexSearch?${searchName}&addRecipeInformation=true&number=12`
      )
      .subscribe(
        (responseId) => {
          this.spinner.hide();
